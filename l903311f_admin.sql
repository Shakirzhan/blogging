...
--
-- Хост: localhost
-- Время создания: Дек 26 2018 г., 21:35
...
-- Последнее обновление: Дек 26 2018 г., 15:30
--
...
(15, 'img/26.12.2018.1545832707.png', 'Во всем виноват смартфон: современные дети разучились общаться', 'На консультацию часто приходят родители с жалобой на то, что ребенок невнимательный, гиперактивный.  Следует разделить понятия  гиперактивный и просто активный ребенок. Гиперактивность (СДВГ)  – это диагноз, который ставит невролог. Но в последнее время мы все чаще наблюдаем у детей противоположные отклонения – это расстройства аутического плана.  Это не больные аутизмом дети, но проявляют они себя похоже – они замкнуты, живут в своем мире, очень поздно начинают говорить, им трудно взаимодействовать с другими людьми. Такой тип поведения мешает им в учебе.', 0, 0, '2018-12-26', 5),
(16, 'img/26.12.2018.1545832871.png', 'Во всем виноват смартфон: современные дети разучились общаться', 'На консультацию часто приходят родители с жалобой на то, что ребенок невнимательный, гиперактивный.  Следует разделить понятия  гиперактивный и просто активный ребенок. Гиперактивность (СДВГ)  – это диагноз, который ставит невролог. Но в последнее время мы все чаще наблюдаем у детей противоположные отклонения – это расстройства аутического плана.  Это не больные аутизмом дети, но проявляют они себя похоже – они замкнуты, живут в своем мире, очень поздно начинают говорить, им трудно взаимодействовать с другими людьми. Такой тип поведения мешает им в учебе.', 0, 0, '2018-12-26', 5),
(30, '', 'Во всем виноват смартфон: современные дети разучились общаться', 'На консультацию часто приходят родители с жалобой на то, что ребенок невнимательный, гиперактивный.  Следует разделить понятия  гиперактивный и просто активный ребенок. Гиперактивность (СДВГ)  – это диагноз, который ставит невролог. Но в последнее время мы все чаще наблюдаем у детей противоположные отклонения – это расстройства аутического плана.  Это не больные аутизмом дети, но проявляют они себя похоже – они замкнуты, живут в своем мире, очень поздно начинают говорить, им трудно взаимодействовать с другими людьми. Такой тип поведения мешает им в учебе.', 0, 0, '2018-12-26', 6);
